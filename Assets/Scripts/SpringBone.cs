...
namespace UnityChan
{
    public class SpringBone : MonoBehaviour
    {
        ...
        public void UpdateSpring()
        {
            ...
            // delta时间平方
            float sqrDt = 1;// Time.deltaTime * Time.deltaTime;
            float sqrDt2 = Time.deltaTime * Time.deltaTime;
            ...
            force += drag / sqrDt; // 阻力 = 还原到前一帧位置的力

            force += springForce / sqrDt; // RandomWind 的 Update 里添加的外力，风力、重力
